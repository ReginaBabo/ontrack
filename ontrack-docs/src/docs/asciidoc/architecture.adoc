...
Finally, the `kdsl*` modules deal with the interface and
implementation of the <<architecture-kdsl,Kotlin-based DSL>> used as a client
for Ontrack.
...
// Sub sections for Architecture

include::architecture-kdsl.adoc[]
